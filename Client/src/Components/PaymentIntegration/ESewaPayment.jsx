...
const ESewaPayment = () => {
    ...
    const { amount, bookingId, returnUrl } = location.state || {};
    ...
    const [formData, setFormData] = React.useState({
        ...
        success_url: `http://localhost:5173/success?bookingId=${bookingId}&returnUrl=${encodeURIComponent(returnUrl || '/')}`,
        failure_url: `http://localhost:5173/failed?bookingId=${bookingId}&returnUrl=${encodeURIComponent(returnUrl || '/')}`,
